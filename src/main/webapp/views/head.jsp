    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="/views/home.jsp">Залоговые билеты <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">Склад</a>
            </li>
            <li class="nav-item">
                <a class="nav-link " href="/views/operation.jsp">Операции</a>
            </li>
            <li class="nav-item">
                <a class="nav-link " href="/views/documentation.jsp">Документы</a>
            </li>
        </ul>
...
<script src="bootstrap/css/js/bootstrap.min.js" integrity="VjEeINv9OSwtWFLAtmc4JCtEJXXBub00gtSnszmspDLCtC0I4z4nqz7rEFbIZLLU" crossorigin="anonymous"></script>
